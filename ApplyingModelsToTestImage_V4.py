...
# from TestData_V4 import TestData2_MultThalamus_PerSlice
import os
import numpy as np
import nibabel as nib
from tf_unet import unet, util, image_util
...
NeucleusFolder = 'CNN4_VLP_2DSlicesSeperately' #'CNN_Thalamus' #
...
for ii in range(0,len(A)):
    ...
    Directory_Nuclei_Label   = Directory_main   + '/OriginalDeformedPriors/' +  subFolders[sFi] + '/ManualDelineation/' + NucleusName + '_Deformed.nii.gz'
    Directory_Thalamus_Label = Directory_main + '/OriginalDeformedPriors/' +  subFolders[sFi] + '/ManualDelineation/' + '1-THALAMUS'+ '_Deformed.nii.gz'
    ...
    padSize = 90
    # [Prediction3D_Mult, Prediction3D_Mult_logical] = TestData2_MultThalamus_PerSlice(net , Directory_Nuclei_Test , Directory_Nuclei_Train , OriginalSeg , subFolders[sFi] , CropDimensions , padSize , Directory_Thalamus_Test , Directory_Thalamus_TrainedModel , NucleusName , SliceNumbers , 1)
    ## ---------------------------------------------
    ...
    PredictionFull_Thalamus = ThalamusExtraction(net , Directory_Thalamus_Test , Directory_Thalamus_TrainedModel , subFolders[sFi], CropDim , padSize)
...
# ax[1,0].imshow(InputLabel[sn,45:148+45,45:148+45,1], cmap = 'gray')
# ax[1,1].imshow(InputData[sn,45:148+45,45:148+45,0], cmap = 'gray')
# ax[0,2].imshow(CC[:,:,snB],cmap='gray')
plt.show()

# K = CC[:,:,snB]*1 + InputLabel[ sn , 45:148+45 , 45:148+45 , 1 ]*0
# plt.imshow(K)
# plt.show()

# print OrigLabel.shape
