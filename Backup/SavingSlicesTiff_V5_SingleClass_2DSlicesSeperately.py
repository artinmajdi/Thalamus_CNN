...
NeucleusFolder = 'CNN6_VLP_2D_PerSlice'
NeuclusName = '6-VLP' # '1-THALAMUS' 

# Directory_Priors = '/media/data1/artin/data/Thalamus/'+ NeucleusFolder + '/OriginalDeformedPriors'
Directory_Priors = '/localhome/msmajdi_local/data/priors_forCNN'
...
for ii in range(len(A)):
    ...
    Directory_Test = '/localhome/msmajdi_local/Tests/Thalamus_CNN/'+ NeucleusFolder + '/Test_' + TestName
