...
def TestData3_PerSlice(net , MultByThalamusFlag, Directory_Nuclei_Test0 , Directory_Nuclei_Train0 , OriginalSeg , subFolders, CropDim , padSize , Directory_Thalamus_Test , Directory_Thalamus_TrainedModel , NucleusName , SliceNumbers):
    ...
    for sliceInd in range(L):
        ...
        if MultByThalamusFlag != 0:
            Directory_Test_Results_Thalamus = Directory_Nuclei_Test + 'Results_MultByManualThalamus/'
            try:
        ...
        util.save_image(imgCombined, Directory_Test_Results_Nuclei+"prediction_slice"+ str(SliceNumbers[sliceInd]) + ".jpg")
        ...
        if MultByThalamusFlag != 0:
            ...
            util.save_image(imgCombined, Directory_Test_Results_Thalamus +"prediction_slice"+ str(SliceNumbers[sliceInd]) + ".jpg")
            util.save_image(imgCombined2, Directory_Test_Results_Thalamus+"prediction_slice"+ str(SliceNumbers[sliceInd]) + "2.jpg")
