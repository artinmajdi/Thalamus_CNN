...
import logging
from TestData_V5 import TestData3
from tf_unet import unet, util, image_util
...
print("start ")
gpuNum = "6"
NeucleusFolder = 'CNN5_Thalamus_2D_PerSlice_VTK' #'CNN_Thalamus' #
ThalamusFolder = 'CNN5_Thalamus_2D_PerSlice_VTK' #'CNN_Thalamus' #
...
Directory_Thalamus_Full = Directory_main + ThalamusFolder
...
for ii in range(1): # len(A)):
    ...
    # print len(subFolders)Directory_Nuclei_Label
    ...
    for sFi in range(len(subFolders)):
        ...
        for sliceInd in range(33):
            ...
            Directory_Thalamus_Test  = Directory_Thalamus + subFolders[sFi] + '/Test/Slice' + str(sliceInd) + '/'
            Directory_Thalamus_Train = Directory_Thalamus + subFolders[sFi] + '/Train/Slice' + str(sliceInd) + '/'
            ...
            if os.path.isfile(TestResults_Path + 'Dice__Coefficient.txt'):
                ...
                path = trainer.train(TrainData, Directory_Nuclei_Train_Model, training_iters=100, epochs=4, display_step=500, GPU_Num=gpuNum)
                ...
                [A, B] = TestData3_PerSlice(net , MultByThalamusFlag, Directory_Nuclei_Test , Directory_Nuclei_Train , OriginalSegFull , subFolders[sFi] , CropDimensions , padSize , gpuNum)
                                        # TestData3(net , MultByThalamusFlag, Directory_Nuclei_Test0 , Directory_Nuclei_Train0 , OriginalSeg , subFolders, CropDim , padSize , Directory_Thalamus_Test , Directory_Thalamus_TrainedModel , NucleusName , SliceNumbers):
