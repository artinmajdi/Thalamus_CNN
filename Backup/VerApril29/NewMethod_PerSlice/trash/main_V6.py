    ...
    for sFi in range(len(subFolders)):
        ...
        for sliceInd in range(33):
            ...
            if os.path.isfile(Directory_Nuclei_Train_Model + 'checkpoint'):
                ...
                padSize = 90
                [data,label,prediction] = TestData3(net , MultByThalamusFlag, Directory_Nuclei_Test  , Directory_Nuclei_Train  , OriginalSegFull , subFolders[sFi] , CropDimensions , padSize , Directory_Thalamus_Test , Directory_Thalamus_Train_Model , NucleusName , SliceNumbers)
