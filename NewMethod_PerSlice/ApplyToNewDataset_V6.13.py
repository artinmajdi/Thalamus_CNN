...
def initialDirectories(Params , ind = 1, mode = 'local' , dataset = 'old' , method = 'new'):
    ...
    if 'local' in mode:
        ...
        Params['Dir_AllTests_restore']  = '/media/artin/dataLocal1/dataThalamus/AllTests/' + 'old' + 'Dataset_' + 'new' +'Method'
        ...
        Params['Dir_AllTests_restore']  = '/array/' + hardDrive + '/msmajdi/Tests/Thalamus_CNN/' + 'old' + 'Dataset_' + 'new' +'Method'
...
def trainFunc(Params , slcIx):
    ...
    Params['restorePath'] = Params['restorePath_full'] + '/Slice_' + str(sliceNum) + '/' + Params['modelName']
...
def paramIterEpoch(Params , slcIx):
    ...
    elif Params['IxNuclei'][0] in [2,12,13]:
        Params['epochs'] = 10
