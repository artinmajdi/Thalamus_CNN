...
def TestData3(net , MultByThalamusFlag, Dir_ResultsOut , Directory_Nuclei_Test0 , Dir_NucleiModelOut , Thalamus_OriginalSeg , Nuclei_OriginalSeg , subFolders, CropDim , padSize , Directory_Thalamus_Test , Directory_Thalamus_TrainedModel , NucleusName , SliceNumbers , gpuNum):


    Dir_NucleiModelOut_cptk = Dir_NucleiModelOut + 'model.cpkt'
    Directory_Test_Results_Nuclei = Dir_ResultsOut #'Results_momentum/' #
