        ...
        for sFi in L:
            ...
            if UserEntries['init']:
                ...
                if Params['gpuNum'] != 'nan':
                    # path2 = ''
                    path = trainer.train(TrainData, Dir_NucleiModelOut, training_iters=400, epochs=3, display_step=500, GPU_Num=Params['gpuNum'] ,prediction_path=Dir_ResultsOut , restore='True')
                else:
