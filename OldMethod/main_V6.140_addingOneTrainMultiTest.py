    ...
    for ii in L:
        ...
        if UserEntries['init']:
            if 'Unlabeled' in UserEntries['dataset']:
                ...
                if 'onetrain' in UserEntries['testmode']:
                    Params['restorePath'] = Params['Dir_AllTests_restore'] + Params['NeucleusFolder'] + '/' + TestName + '/' + 'OneTrain_MultipleTest' + '/Train/' + 'model/' # Params['modelName'] #  'model/' #
                else:
                    Params['restorePath'] = Params['Dir_AllTests_restore'] + Params['NeucleusFolder'] + '/' + TestName + '/' + 'vimp2_1519_04212015' + '/Train/' + 'model/' # Params['modelName'] #  'model/' #
        ...
        for sFi in L2:
            ...
            if Params['Flag_cross_entropy'] == 1:
                ...
                cost_kwargs = {'learning_rate':1e-4}
                Params['net'] = unet.Unet(layers=4, features_root=16, channels=1, n_class=2 , summaries=True , cost_kwargs=cost_kwargs) # , cost="dice_coefficient"
