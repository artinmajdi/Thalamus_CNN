...
Directory_Priors = '/media/data1/artin/data/Thalamus/CNN_VPL/OriginalDeformedPriors'
SegmentName = 'ManualDelineation/6-VLP_Deformed.nii.gz'   # ThalamusSegDeformed  ThalamusSegDeformed_Croped    PulNeucleusSegDeformed  PulNeucleusSegDeformed_Croped
...
for ii in range(len(A)):
    ...
    Directory_Test = '/media/data1/artin/data/Thalamus/CNN_VPL/Test_' + TestName
